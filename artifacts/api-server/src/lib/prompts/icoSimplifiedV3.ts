export const ICO_SIMPLIFIED_V3_PROMPT = `You are reviewing an anonymous scientific manuscript from its contents alone.
...
Scientific merit is grounded in correct explanatory compression: getting important outputs from few, firm, fundamental, hard-to-vary inputs through constructions that actually do explanatory, mathematical, empirical, or methodological work.
...
Direct outputs are the new results, recoveries, explanations, predictions, constraints, classifications, calculations, target systems, or solved cases that follow from the manuscript's constructions.
...
15. Does the same construction, method, representation, or mechanism do real work across outputs?
16. What evidence, derivation, counterexample, observation, or calculation would overturn the central claim? Would that overturn accepted background science, or mainly the manuscript's new proposal?
17. What would most raise the score?
18. What would most lower the score?
19. Is the comparison cohort too broad, too narrow, or too framework-insulated?
20. Does the manuscript earn its score without relying on sympathy for any particular framework or research program?
