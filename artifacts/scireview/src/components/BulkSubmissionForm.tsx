      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-6">
          ...
          >
            ...
            <p className="text-sm text-slate-400 mt-1">Each PDF will be reviewed sequentially by GPT-5.2</p>
          </div>
                ...
                {files.map(f => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {f.status === 'processing' && (
                        <p className="text-xs text-indigo-600 mt-0.5">Reviewing with GPT-5.2...</p>
                      )}
                    </div>
