          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-indigo-200 uppercase tracking-widest">
                Blind AI Review · {model === 'gemini' ? 'Gemini Flash + Pro' : 'GPT-5.4 Pro'}
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                {([
                  { id: 'gemini', label: 'Gemini Flash + Pro' },
                  ...
                  {files.map(qf => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {qf.status === 'processing' && (
                          <p className="text-xs text-indigo-500">Reviewing with {model === 'gemini' ? 'Gemini Flash + Pro' : 'GPT-5.4 Pro'}…</p>
                        )}
          ...
          >
            {isSubmitting ? (
              <>
                ...
                {isBatch ? `${doneCount}/${files.length} done…` : `Reviewing with ${model === 'gemini' ? 'Gemini Flash + Pro' : 'GPT-5.4 Pro'}…`}
              </>
            ) : (
              <>
